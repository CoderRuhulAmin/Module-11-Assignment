            ...
            <div id="sidebar-img">
              ...
              <div class="d-flex gap-2 flex-wrap img-switch">
                ...
                <div class="form-check sidebar-setting card-radio">
                  ...
                  >
                    <img
                      src="{{ asset( 'assets/images' ) }}/sidebar/img-1.jpg"
                      alt=""
                ...
                <div class="form-check sidebar-setting card-radio">
                  ...
                  >
                    <img
                      src="{{ asset( 'assets/images' ) }}/sidebar/img-2.jpg"
                      alt=""
                      class="avatar-md w-auto object-fit-cover"
                    />
                  </label>
                ...
                <div class="form-check sidebar-setting card-radio">
                  ...
                  >
                    <img
                      src="{{ asset( 'assets/images' ) }}/sidebar/img-3.jpg"
                      alt=""
                      class="avatar-md w-auto object-fit-cover"
                    />
                  </label>
                ...
                <div class="form-check sidebar-setting card-radio">
                  ...
                  >
                    <img
                      src="{{ asset( 'assets/images' ) }}/sidebar/img-4.jpg"
                      alt=""
                      class="avatar-md w-auto object-fit-cover"
                    />
                  </label>
